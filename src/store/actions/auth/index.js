...
export const foo = async () => {
    try {
        console.log("chalaaaaaaaaaaaaaaaaaa")
        // const { data } = await axios.get("https://us-central1-ranked-89d7d.cloudfunctions.net/test")

        functions().
            httpsCallable('test')().then((data) => {
    ...
    return dispatch => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                console.log(
                    'TCL ~ file: index.js ~ line 160 ~ returnnewPromise ~ e',
                    e,
                );
                reject(e, 'error');
            }
...
//   console.log('timeline function started');
//   const data = await axios(
//     `http://localhost:5000/ranked-89d7d/us-central1/timelineData?user_id=12345`,
//   )
